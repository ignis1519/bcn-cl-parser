...
## Motivación
Este es un proyecto personal con el solo fin de ponerme al día con las tendencias actuales con Java (viniendo de un Java dev con 9 años de experiencia *hands-on*, sin haber tocado Spring ni Springboot).
